...
static func bind_quilla_externals(story: QuillaStory, bind_impure_funcs: bool) -> void:
	story.bind_pure_function(&"has_flag",  PlayerStateSubsystem.has_flag)
	story.bind_pure_function(&"has_flag", PlayerStateSubsystem.flag_count)
	...
	if bind_impure_funcs:
		story.bind_impure_function(&"give_flag", PlayerStateSubsystem.give_flag)
		story.bind_impure_function(&"take_flag",  PlayerStateSubsystem.take_flag)
